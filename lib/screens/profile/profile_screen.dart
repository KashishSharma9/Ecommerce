...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    SizedBox(
      ...
      child: Column (
      children: [
          const SCircularImage(image: SImages.user, width: 80, height: 80, padding: 0,),
          ...
          const SizedBox(height: SSizes.spaceBtwItems),
             ...
             SProfileMenu(onPressed: () {  }, title: 'Name',value: 'Kashish',),
              SProfileMenu(title: 'Username', value: 'Kashish_', onPressed: (){}),
              const SizedBox(height: SSizes.spaceBtwItems),
              const Divider(),
              const SizedBox(height: SSizes.spaceBtwItems),
